...
public class SimpleClassLoader extends ClassLoader {
	...
	public SimpleClassLoader(String pathName) {
		// 拿到class转成的字节码文件
	...
	public static void main(String[] args) {
		...
		SimpleClassLoader classLoader = new SimpleClassLoader(
				"../classloader-child/target/classes/com/demo/classloader/child/Test.class");
		try {
			// 这里要把包路径传入进去
			Class<?> clazz = classLoader.loadClass("com.demo.classloader.child.Test");
